...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(Backup_IP, 0, 4, 1, 1);
        ...
        gridLayout->addWidget(Backup_Port, 0, 6, 1, 1);
        ...
        gridLayout->addWidget(AllFlowLE, 2, 6, 1, 1);
        ...
        gridLayout->addWidget(LDN_LE, 1, 6, 1, 1);
