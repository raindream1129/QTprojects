...
public:
    ...
    QLineEdit *SYS_ST_LE;
    QLabel *label_23;
    QPushButton *SYS_STATUS_BTN;
    QPushButton *pushButton_6;
    QLabel *label_45;
    QComboBox *TOTALIZER_STYLE_CB;
    QPushButton *RD_MTRLGC_DATA_BTN;
    ...
    QLabel *label_42;
    QLabel *label_43;
    QPushButton *RD_TEMP_BTN;
    QLineEdit *lineEdit;
    QLineEdit *lineEdit_2;
    QPushButton *RD_FIRMWARE_VERSION_BTN;
    QPushButton *RD_OFFLINE_TIME_BTN;
    QLabel *label_39;
    QLineEdit *Device_timeLE;
    QLabel *label_13;
    QPushButton *RD_RUNNIN_TIME_BTN;
    QPushButton *RD_MIN_FLOW_BTN;
    QComboBox *ModleChgCBB;
    QPushButton *RD_EXTERNAL_V;
    QPushButton *ModleBTN;
    QPushButton *RD_IDLE_TIME_BTN;
    QPushButton *RD_THRESHOLD_BTN;
    QPushButton *RD_MAX_FLOW_BTN;
    QPushButton *RD_ILDE_OVERTIME_BTN;
    QPushButton *RD_OVERDRAFT_BTN;
    QPushButton *RD_BALANCE_BTN;
    QPushButton *RD_ALARM_BALANCE_BTN;
    QPushButton *FIRMWARE_VERSION_BTN;
    QPushButton *RD_REMAINGAS_BTN;
    QPushButton *RD_MODEL_BTN;
    QLabel *label_44;
    QLineEdit *FIRMWARE_VERSION_LE;
    QPushButton *pushButton_5;
    QLineEdit *ALLOWANCE_PROMPT;
    QLabel *label_11;
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        sizePolicy1.setHeightForWidth(BtnClsV->sizePolicy().hasHeightForWidth());
        BtnClsV->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(BtnOpenV->sizePolicy().hasHeightForWidth());
        BtnOpenV->setSizePolicy(sizePolicy1);
        ...
        sizePolicy.setHeightForWidth(Clear_NormalBTN->sizePolicy().hasHeightForWidth());
        Clear_NormalBTN->setSizePolicy(sizePolicy);

        gridLayout_4->addWidget(Clear_NormalBTN, 1, 1, 1, 1);

        Report_ST_BTN = new QPushButton(frame_3);
        Report_ST_BTN->setObjectName(QStringLiteral("Report_ST_BTN"));
        QSizePolicy sizePolicy2(QSizePolicy::Expanding, QSizePolicy::Fixed);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(Report_ST_BTN->sizePolicy().hasHeightForWidth());
        Report_ST_BTN->setSizePolicy(sizePolicy2);

        gridLayout_4->addWidget(Report_ST_BTN, 0, 2, 1, 1);
        ...
        gridLayout_9->addLayout(gridLayout_4, 0, 1, 2, 1);
        ...
        dateTimeEdit->setDateTime(QDateTime(QDate(2017, 12, 26), QTime(15, 0, 0)));
        ...
        gridLayout_7->addWidget(BtnVth, 1, 7, 1, 1);
        ...
        gridLayout_7->addWidget(label_18, 2, 3, 1, 1);
        ...
        gridLayout_7->addWidget(MAX_FLOW_LE, 2, 4, 1, 1);
        ...
        gridLayout_7->addWidget(MaxFlowBTN, 2, 7, 1, 1);
        ...
        gridLayout_7->addWidget(label_24, 2, 5, 1, 1);
        ...
        SYS_STATUS_BTN = new QPushButton(groupBox_3);
        SYS_STATUS_BTN->setObjectName(QStringLiteral("SYS_STATUS_BTN"));

        gridLayout_7->addWidget(SYS_STATUS_BTN, 2, 2, 1, 1);

        pushButton_6 = new QPushButton(groupBox_3);
        pushButton_6->setObjectName(QStringLiteral("pushButton_6"));

        gridLayout_7->addWidget(pushButton_6, 9, 6, 1, 1);

        label_45 = new QLabel(groupBox_3);
        label_45->setObjectName(QStringLiteral("label_45"));

        gridLayout_7->addWidget(label_45, 9, 3, 1, 1);

        TOTALIZER_STYLE_CB = new QComboBox(groupBox_3);
        TOTALIZER_STYLE_CB->setObjectName(QStringLiteral("TOTALIZER_STYLE_CB"));

        gridLayout_7->addWidget(TOTALIZER_STYLE_CB, 9, 4, 1, 1);

        RD_MTRLGC_DATA_BTN = new QPushButton(groupBox_3);
        RD_MTRLGC_DATA_BTN->setObjectName(QStringLiteral("RD_MTRLGC_DATA_BTN"));

        gridLayout_7->addWidget(RD_MTRLGC_DATA_BTN, 1, 2, 1, 1);

        pushButton_7 = new QPushButton(groupBox_3);
        pushButton_7->setObjectName(QStringLiteral("pushButton_7"));

        gridLayout_7->addWidget(pushButton_7, 9, 7, 1, 1);

        pushButton_8 = new QPushButton(groupBox_3);
        pushButton_8->setObjectName(QStringLiteral("pushButton_8"));

        gridLayout_7->addWidget(pushButton_8, 8, 7, 1, 1);
        ...
        gridLayout_7->addWidget(label_3, 1, 5, 1, 1);

        label_4 = new QLabel(groupBox_3);
        label_4->setObjectName(QStringLiteral("label_4"));

        gridLayout_7->addWidget(label_4, 1, 3, 1, 1);
        ...
        gridLayout_7->addWidget(lineEVTh, 1, 4, 1, 1);
        ...
        gridLayout_7->addWidget(label_20, 3, 3, 1, 1);
        ...
        gridLayout_7->addWidget(Min_Flow_LE, 3, 4, 1, 1);
        ...
        gridLayout_7->addWidget(MinFlow_BTN, 3, 7, 1, 1);
        ...
        gridLayout_7->addWidget(IdledTs_LE, 4, 4, 1, 1);
        ...
        gridLayout_7->addWidget(label_38, 4, 5, 1, 1);
        ...
        gridLayout_7->addWidget(label_35, 4, 3, 1, 1);
        ...
        gridLayout_7->addWidget(label_21, 5, 3, 1, 1);
        ...
        gridLayout_7->addWidget(IdleT_LE, 5, 4, 1, 1);
        ...
        gridLayout_7->addWidget(AlarmFlow_BTN, 6, 7, 1, 1);
        ...
        gridLayout_7->addWidget(label_15, 6, 3, 1, 1);
        ...
        gridLayout_7->addWidget(IdleT_BTN, 5, 7, 1, 1);
        ...
        gridLayout_7->addWidget(Alarm_Bal_LE, 6, 4, 1, 1);
        ...
        gridLayout_7->addWidget(label_16, 7, 3, 1, 1);
        ...
        gridLayout_7->addWidget(Alarm_Gas_LE, 7, 4, 1, 1);

        label_41 = new QLabel(groupBox_3);
        label_41->setObjectName(QStringLiteral("label_41"));

        gridLayout_7->addWidget(label_41, 8, 3, 1, 1);
        ...
        gridLayout_7->addWidget(Balance_BTN, 7, 7, 1, 1);
        ...
        gridLayout_7->addWidget(label_10, 7, 5, 1, 1);

        label_40 = new QLabel(groupBox_3);
        label_40->setObjectName(QStringLiteral("label_40"));

        gridLayout_7->addWidget(label_40, 6, 5, 1, 1);

        label_42 = new QLabel(groupBox_3);
        label_42->setObjectName(QStringLiteral("label_42"));

        gridLayout_7->addWidget(label_42, 8, 5, 1, 1);
        ...
        RD_TEMP_BTN = new QPushButton(groupBox_3);
        RD_TEMP_BTN->setObjectName(QStringLiteral("RD_TEMP_BTN"));

        gridLayout_7->addWidget(RD_TEMP_BTN, 6, 2, 1, 1);

        lineEdit = new QLineEdit(groupBox_3);
        lineEdit->setObjectName(QStringLiteral("lineEdit"));

        gridLayout_7->addWidget(lineEdit, 8, 4, 1, 1);
        ...
        RD_FIRMWARE_VERSION_BTN = new QPushButton(groupBox_3);
        RD_FIRMWARE_VERSION_BTN->setObjectName(QStringLiteral("RD_FIRMWARE_VERSION_BTN"));

        gridLayout_7->addWidget(RD_FIRMWARE_VERSION_BTN, 5, 2, 1, 1);

        RD_OFFLINE_TIME_BTN = new QPushButton(groupBox_3);
        RD_OFFLINE_TIME_BTN->setObjectName(QStringLiteral("RD_OFFLINE_TIME_BTN"));

        gridLayout_7->addWidget(RD_OFFLINE_TIME_BTN, 7, 2, 1, 1);
        ...
        gridLayout_7->addWidget(label_13, 0, 3, 1, 1);

        RD_RUNNIN_TIME_BTN = new QPushButton(groupBox_3);
        RD_RUNNIN_TIME_BTN->setObjectName(QStringLiteral("RD_RUNNIN_TIME_BTN"));

        gridLayout_7->addWidget(RD_RUNNIN_TIME_BTN, 4, 2, 1, 1);

        RD_MIN_FLOW_BTN = new QPushButton(groupBox_3);
        RD_MIN_FLOW_BTN->setObjectName(QStringLiteral("RD_MIN_FLOW_BTN"));

        gridLayout_7->addWidget(RD_MIN_FLOW_BTN, 3, 6, 1, 1);
        ...
        sizePolicy3.setHeightForWidth(ModleChgCBB->sizePolicy().hasHeightForWidth());
        ModleChgCBB->setSizePolicy(sizePolicy3);
        QFont font4;
        font4.setPointSize(10);
        ModleChgCBB->setFont(font4);

        gridLayout_7->addWidget(ModleChgCBB, 0, 4, 1, 1);

        RD_EXTERNAL_V = new QPushButton(groupBox_3);
        RD_EXTERNAL_V->setObjectName(QStringLiteral("RD_EXTERNAL_V"));

        gridLayout_7->addWidget(RD_EXTERNAL_V, 3, 2, 1, 1);
        ...
        sizePolicy4.setHeightForWidth(ModleBTN->sizePolicy().hasHeightForWidth());
        ModleBTN->setSizePolicy(sizePolicy4);

        gridLayout_7->addWidget(ModleBTN, 0, 7, 1, 1);

        RD_IDLE_TIME_BTN = new QPushButton(groupBox_3);
        RD_IDLE_TIME_BTN->setObjectName(QStringLiteral("RD_IDLE_TIME_BTN"));

        gridLayout_7->addWidget(RD_IDLE_TIME_BTN, 4, 6, 1, 1);

        RD_THRESHOLD_BTN = new QPushButton(groupBox_3);
        RD_THRESHOLD_BTN->setObjectName(QStringLiteral("RD_THRESHOLD_BTN"));

        gridLayout_7->addWidget(RD_THRESHOLD_BTN, 1, 6, 1, 1);

        RD_MAX_FLOW_BTN = new QPushButton(groupBox_3);
        RD_MAX_FLOW_BTN->setObjectName(QStringLiteral("RD_MAX_FLOW_BTN"));

        gridLayout_7->addWidget(RD_MAX_FLOW_BTN, 2, 6, 1, 1);

        RD_ILDE_OVERTIME_BTN = new QPushButton(groupBox_3);
        RD_ILDE_OVERTIME_BTN->setObjectName(QStringLiteral("RD_ILDE_OVERTIME_BTN"));

        gridLayout_7->addWidget(RD_ILDE_OVERTIME_BTN, 5, 6, 1, 1);

        RD_OVERDRAFT_BTN = new QPushButton(groupBox_3);
        RD_OVERDRAFT_BTN->setObjectName(QStringLiteral("RD_OVERDRAFT_BTN"));

        gridLayout_7->addWidget(RD_OVERDRAFT_BTN, 8, 2, 1, 1);

        RD_BALANCE_BTN = new QPushButton(groupBox_3);
        RD_BALANCE_BTN->setObjectName(QStringLiteral("RD_BALANCE_BTN"));

        gridLayout_7->addWidget(RD_BALANCE_BTN, 6, 6, 1, 1);

        RD_ALARM_BALANCE_BTN = new QPushButton(groupBox_3);
        RD_ALARM_BALANCE_BTN->setObjectName(QStringLiteral("RD_ALARM_BALANCE_BTN"));

        gridLayout_7->addWidget(RD_ALARM_BALANCE_BTN, 8, 6, 1, 1);

        FIRMWARE_VERSION_BTN = new QPushButton(groupBox_3);
        FIRMWARE_VERSION_BTN->setObjectName(QStringLiteral("FIRMWARE_VERSION_BTN"));

        gridLayout_7->addWidget(FIRMWARE_VERSION_BTN, 9, 2, 1, 1);

        RD_REMAINGAS_BTN = new QPushButton(groupBox_3);
        RD_REMAINGAS_BTN->setObjectName(QStringLiteral("RD_REMAINGAS_BTN"));

        gridLayout_7->addWidget(RD_REMAINGAS_BTN, 7, 6, 1, 1);

        RD_MODEL_BTN = new QPushButton(groupBox_3);
        RD_MODEL_BTN->setObjectName(QStringLiteral("RD_MODEL_BTN"));

        gridLayout_7->addWidget(RD_MODEL_BTN, 0, 6, 1, 1);

        label_44 = new QLabel(groupBox_3);
        label_44->setObjectName(QStringLiteral("label_44"));

        gridLayout_7->addWidget(label_44, 9, 0, 1, 1);

        FIRMWARE_VERSION_LE = new QLineEdit(groupBox_3);
        FIRMWARE_VERSION_LE->setObjectName(QStringLiteral("FIRMWARE_VERSION_LE"));
        FIRMWARE_VERSION_LE->setEnabled(false);

        gridLayout_7->addWidget(FIRMWARE_VERSION_LE, 9, 1, 1, 1);

        pushButton_5 = new QPushButton(groupBox_3);
        pushButton_5->setObjectName(QStringLiteral("pushButton_5"));

        gridLayout_7->addWidget(pushButton_5, 10, 7, 1, 1);

        ALLOWANCE_PROMPT = new QLineEdit(groupBox_3);
        ALLOWANCE_PROMPT->setObjectName(QStringLiteral("ALLOWANCE_PROMPT"));

        gridLayout_7->addWidget(ALLOWANCE_PROMPT, 10, 4, 1, 1);

        label_11 = new QLabel(groupBox_3);
        label_11->setObjectName(QStringLiteral("label_11"));

        gridLayout_7->addWidget(label_11, 10, 3, 1, 1);

        pushButton_9 = new QPushButton(groupBox_3);
        pushButton_9->setObjectName(QStringLiteral("pushButton_9"));

        gridLayout_7->addWidget(pushButton_9, 10, 6, 1, 1);

        label_46 = new QLabel(groupBox_3);
        label_46->setObjectName(QStringLiteral("label_46"));

        gridLayout_7->addWidget(label_46, 10, 5, 1, 1);
        ...
        sizePolicy4.setHeightForWidth(AvoidPeakClouseBTN->sizePolicy().hasHeightForWidth());
        AvoidPeakClouseBTN->setSizePolicy(sizePolicy4);
        AvoidPeakClouseBTN->setFont(font3);
        ...
        sizePolicy4.setHeightForWidth(PLMN_BTN->sizePolicy().hasHeightForWidth());
        PLMN_BTN->setSizePolicy(sizePolicy4);
        PLMN_BTN->setFont(font3);
        ...
        sizePolicy4.setHeightForWidth(BACKSevIPBTN->sizePolicy().hasHeightForWidth());
        BACKSevIPBTN->setSizePolicy(sizePolicy4);
        BACKSevIPBTN->setFont(font3);
        ...
        sizePolicy4.setHeightForWidth(AvoidPeakOpenBTN->sizePolicy().hasHeightForWidth());
        AvoidPeakOpenBTN->setSizePolicy(sizePolicy4);
        AvoidPeakOpenBTN->setFont(font3);
        ...
        sizePolicy4.setHeightForWidth(BandWidthBTN->sizePolicy().hasHeightForWidth());
        BandWidthBTN->setSizePolicy(sizePolicy4);
        BandWidthBTN->setFont(font3);
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        Report_ST_BTN->setText(QApplication::translate("Widget", "\346\237\245\347\234\213\344\270\212\346\212\245\347\212\266\346\200\201", 0));
        ...
        SYS_STATUS_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        pushButton_6->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        label_45->setText(QApplication::translate("Widget", "\347\264\257\345\212\240\345\231\250\347\261\273\345\236\213", 0));
        TOTALIZER_STYLE_CB->clear();
        TOTALIZER_STYLE_CB->insertItems(0, QStringList()
         << QApplication::translate("Widget", "\345\205\211\347\224\265\347\233\264\350\257\273", 0)
         << QApplication::translate("Widget", "\345\271\262\347\260\247\347\256\241", 0)
        );
        RD_MTRLGC_DATA_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        pushButton_7->setText(QApplication::translate("Widget", "\350\256\276\347\275\256", 0));
        pushButton_8->setText(QApplication::translate("Widget", "\350\256\276\347\275\256", 0));
        ...
        label_17->setText(QApplication::translate("Widget", "\351\205\215\347\275\256\347\211\210\346\234\254\345\217\267", 0));
        ...
        label_40->setText(QApplication::translate("Widget", "\345\210\206", 0));
        label_42->setText(QApplication::translate("Widget", "\345\210\206", 0));
        label_43->setText(QApplication::translate("Widget", "\351\200\217\346\224\257\351\242\235\345\272\246", 0));
        RD_TEMP_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        RD_FIRMWARE_VERSION_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        RD_OFFLINE_TIME_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        ...
        RD_RUNNIN_TIME_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        RD_MIN_FLOW_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        ModleChgCBB->clear();
        ...
        RD_EXTERNAL_V->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        ModleBTN->setText(QApplication::translate("Widget", "\350\256\276\347\275\256", 0));
        RD_IDLE_TIME_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        RD_THRESHOLD_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        RD_MAX_FLOW_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        RD_ILDE_OVERTIME_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        RD_OVERDRAFT_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        RD_BALANCE_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        RD_ALARM_BALANCE_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        FIRMWARE_VERSION_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        RD_REMAINGAS_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        RD_MODEL_BTN->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        label_44->setText(QApplication::translate("Widget", "\345\233\272\344\273\266\347\211\210\346\234\254\345\217\267", 0));
        pushButton_5->setText(QApplication::translate("Widget", "\350\256\276\347\275\256", 0));
        label_11->setText(QApplication::translate("Widget", "\350\255\246\347\244\272\344\275\231\351\207\217", 0));
        pushButton_9->setText(QApplication::translate("Widget", "\350\257\273\345\217\226", 0));
        label_46->setText(QApplication::translate("Widget", "m3", 0));
